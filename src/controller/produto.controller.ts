...
import {
  BuscarProdutoResponseDTO,
  ListarProdutosResponseDTO,
} from '../model/produto/dto/listar-produto.dto';
...
export class ProdutoController {
  ...
  async atualizarProduto(
    ...
    return await this.produtoService.atualizarProdutos(
      id,
  ...
  @HttpCode(HttpStatus.OK)
  async desativarProduto(@Param('id', new ParseUUIDPipe()) id: string) {
