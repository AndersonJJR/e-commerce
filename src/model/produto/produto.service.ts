...
export class ProdutoService {
    ...
    async criarProduto(dadosProduto: CriarProdutoDTO) {
        ...
        const caracteristicas = dadosProduto.caracteristicasDoProduto.map(carac => {
    ...
    async atualizarProdutos(id: string, dadosAtualizarProduto: AtualizarProdutoDTO) {
        ...
        if (dadosAtualizarProduto.caracteristicasDoProduto) {
            produto.caracteristicasDoProduto = dadosAtualizarProduto.caracteristicasDoProduto.map(p => {
                const caracteristica = new CaracteristicasProduto();
